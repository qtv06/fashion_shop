...
<body class="animsition">
	...
	?>
				...
				<script>swal("Đăng kí", "Bạn đã đăng kí thành công! Đăng nhập ngay", "success");
	...
	?>
				<script>swal("Đăng kí", "Email này đã được sử dụng! Hãy sử dụng một tài khoản email khác", "warning");
				$(".swal-button").on("click", function(event) {
					event.preventDefault();
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form action="register.php" method="POST">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" id="name" type="text" name="name" placeholder="Tên sử dụng">
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" id="phonenum" type="number" name="numphone" placeholder="Số điện thoại">
